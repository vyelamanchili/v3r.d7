...
<?php if ($page == 0): ?>
  <h2 class="title"><a href="<?php print $node_url?>"><?php print $title?></a>
  <?php
...
<?php endif; ?>
  ...
  <?php if ($submitted && $page != 0) { ?><div class="supermitted"><span class="submitted"><?php print $submitted?></span></div><?php }; ?>
  ...
  <?php print $content?></div>
    ...
    <?php if ($submitted && $page == 0) { ?><div class="submitted-to-right"><span class="submitted"><?php print $submitted?></span></div><?php }; ?> 
